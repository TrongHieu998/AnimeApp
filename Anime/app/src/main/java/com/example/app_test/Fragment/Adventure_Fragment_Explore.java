 ...
 */
public class Adventure_Fragment_Explore extends Fragment {


    private static Adventure_Fragment_Explore instance;

    public static Adventure_Fragment_Explore getInstance() {
        if (instance == null) {
            synchronized (Adventure_Fragment_Explore.class) {
                if (instance == null) {
                    instance = new Adventure_Fragment_Explore();
                }
            }
        }
        return instance;
    }
    public Adventure_Fragment_Explore() {
    ...
    private class Content extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                String url="https://www11.gogoanime.io/genre/adventure";
