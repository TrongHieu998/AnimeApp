 ...
 */
public class Drama_Fragment_Explore extends Fragment {

    private static Drama_Fragment_Explore instance;

    public static Drama_Fragment_Explore getInstance() {
        if (instance == null) {
            synchronized (Drama_Fragment_Explore.class) {
                if (instance == null) {
                    instance = new Drama_Fragment_Explore();
                }
            }
        }
        return instance;
    }
    public Drama_Fragment_Explore() {
    ...
    private class Content extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                String url="https://www11.gogoanime.io/genre/drama";
