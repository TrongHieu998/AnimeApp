 ...
 */
public class Fantasy_Fragment_Explore extends Fragment {


    private static Fantasy_Fragment_Explore instance;

    public static Fantasy_Fragment_Explore getInstance() {
        if (instance == null) {
            synchronized (Fantasy_Fragment_Explore.class) {
                if (instance == null) {
                    instance = new Fantasy_Fragment_Explore();
                }
            }
        }
        return instance;
    }
    public Fantasy_Fragment_Explore() {
    ...
    private class Content extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                String url="https://www11.gogoanime.io/genre/fantasy";
